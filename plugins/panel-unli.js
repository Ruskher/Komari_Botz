...
if (!args[0] || !args[1]) throw `• *Example :* ${usedPrefix}${command} ditz 6288980870067`
try {
...
"body": JSON.stringify({
"name": args[0],
"description": "Powered by : ditzofc",
"user": user.id,
"egg": parseInt(15),
...
teks += '```Email:```' + ` ${args[0]}@ditzofc.shop\n`
teks += '```Username:```' + ` ${args[0]}\n`
teks += '```Password:```' + ` ${randomSevenDigitNumber}\n`
teks += '```Link Panel:```' + ` ${global.domain}\n\n`
await conn.sendFile(args[1] + '@c.us', 'https://telegra.ph/file/d7765910b70edd3226833.jpg', '', teks, m)
...
await conn.reply('120363233575711758@g.us', kata, null)
} else {
...
handler.tags = ['panel']
handler.command = handler.help = ['unli']
handler.owner = true
