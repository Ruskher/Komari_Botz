...
if (!args[0] || !args[1]) throw `• *Example :* ${usedPrefix}${command} Adit 6288980870067`
try {
...
"body": JSON.stringify({
"name": args[0],
"description": "Dont Forget Subs YT Channel @DitzOfc",
"user": user.id,
"egg": parseInt(15),
...
handler.tags = ['panel']
handler.command = handler.help = ['1gb']
handler.owner = true
